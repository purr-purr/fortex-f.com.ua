...
export const financeReports: IDocumentsListGroup[] = [
	{
		...
		list: [
			{
				title:
					'Фортекс Фінанс Примітки 1 півріччя 2025',
				link: importDoc('Фортекс Фінанс Примітки 1 півріччя 2025.pdf'),
			},	{
				title:
					'Ф4. Звіт про власний капітал 1 півріччя 2025',
				...
				link: importDoc('S0100311 Ф3. Звiт про рух грошових коштiв (за прямим методом) (1).pdf'),
			},	{
				title:
					'Ф2. Звіт про фінансові результати (в тисячах) 1 півріччя 2025',
				link: importDoc('S0100215 Ф2. Звіт про фінансові результати (в тисячах) (1).pdf'),
			},	{
				title:
					'Ф1. Баланс 1 півріччя 2025',
				link: importDoc('S0100115 Ф1. Баланс (1).pdf'),
			},	{
				title:
					'Примітки Фортекс-Фінанс 1 квартал 2025',
				link: importDoc('Примітки Фортекс-Фінанс 1 квартал 2025.pdf'),
			},	{
				title:
					'Ф4. Звіт про власний капітал 1 квартал 2025',
				...
				title:
					'Ф2. Звіт про фінансові результати (в тисячах) 1 квартал 2025',
				link: importDoc('S0100215 Ф2. Звіт про фінансові результати (в тисячах).pdf'),
			},	{
				title:
					'Ф1. Баланс 1 квартал 2025',
