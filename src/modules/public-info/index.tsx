		...
		<section className={s.container}>
			<article className={s.inner}>
				<h2 className={s.title}>
					Публічна інформація та інша інформація щодо умов та порядку
					діяльності,
					включно щодо фінансових послуг, які надаються ТОВ «ФОРТЕКС-ФІНАНС»
					клієнту{' '}
				</h2>
				<div className={s.table}>
					<table>
						...
						<tr>
							...
							<td>
								<strong>
									...
									ВІДПОВІДАЛЬНІСТЮ &quot;ФОРТЕКС-ФІНАНС&quot;
								</strong>
						...
						<tr>
							...
							<td>
								...
								<p>
									...
									фінансових послуг для надання ним відповідних видів фінансових
									послуг,
									шляхом розміщення на власному вебсайті наявного зображення
									позначень,
									які є об’єктом торговельної марки, свідоцтва про
									реєстрацію/заявки на
							...
							<td>
								<strong>
									Товариство має зареєстровані торговельні марки але не
									використовує та
								...
								<p>
									Дата реєстрації знака 12.10.2020. Очікувана дата закінчення
									строку дії
									свідоцтва 02.10.2028. Дата публікації та номер бюлетеня
									12.10.2020,
									бюл. № 19/2020.
								</p>
								...
								<p>
									Дата реєстрації знака 25.11.2020. Очікувана дата закінчення
									строку дії
									свідоцтва 06.11.2028. Дата публікації та номер бюлетеня
									25.11.2020,
									бюл. № 22/2020.
								</p>
							</td>
						...
						<tr>
							...
							<td>
								<strong>
									Відомості про державну реєстрацію в Єдиному державному
									реєстрі:
								</strong>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<strong>Адреса місцезнаходження відповідно до відомостей
									ЄДР</strong>
								<strong>
									Фактична адреса місце провадження господарської діяльності з
									надання
									фінансових послуг
								</strong>
							</td>
							<td>
								<p>
									Україна, 02157, місто Київ, Харківське шосе, будинок 19,
									приміщення
									2005, офіс 1
								</p>
							</td>
						...
						<tr>
							...
							<td>
								<strong>
									Перелік власних вебсайтів Товариства, які використовуються
									надавачем
									фін. послуг та на яких здійснюється інформування про умови та
									порядок
							...
							<td>
								<a
									href="https://www.fortex-f.com.ua/">https://www.fortex-f.com.ua/</a>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<strong>
									Перелік керівників фінансової установи та її відокремлених
									підрозділів
								</strong>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<p>
									Товариство включене до Державного реєстру фінансових установ,
									який
									веде Національний банк України. Свідоцтво про реєстрацію
									фінансової
									установи серії <strong>ФК №В0000212</strong>, дата видачі
									свідоцтва{' '}
									<strong>13.04.2021</strong>, дата прийняття та номер рішення
									про
									внесення фінансової установи до Державного реєстру фінансових
									установ{' '}
								...
								<p>
									<strong>
										Посилання на Комплексно інформаційну систему Національного
										банку
										України:
									</strong>{' '}
								...
								<p>
									...
									реєстрацію та авторизацію якого здійснює Національний банк
									України,
									рекомендуємо використовувати всі засоби пошуку, які розміщені
									сторінці
									за посиланням{' '}
									<a
						...
						<tr>
							...
							<td>
								<strong>
									Інформація щодо наявності в особи, яка надає фінансові
									послуги, права
							...
							<td>
								<p>
									...
									<strong>ЛІЦЕНЗІЯ НА ДІЯЛЬНІСТЬ ФІНАНСОВОЇ КОМПАНІЇ</strong>, з
									правом
									надання фінансової послуги{' '}
									<strong>НАДАННЯ КОШТІВ ТА БАНКІВСЬКИХ МЕТАЛІВ У
										КРЕДИТ</strong>, дата
								...
								<p>
									...
									банку
									України: <a
									href="https://kis.bank.gov.ua">https://kis.bank.gov.ua</a>
								</p>
								<p>
									Для отримання повної інформації щодо Товариства, ліцензування,
									реєстрацію та авторизацію якого здійснює Національний банк
						...
						<tr>
							...
							<td>
								<strong>
									Перелік послуг, що надаються фінансовою установою, порядок та
									умови їх
									надання
								</strong>
							</td>
							<td>
								...
								<p>
									...
									осіб-підприємців. Товариство не здійснює кредитування
									споживачів.
						...
						<tr>
							...
							<td>
								<strong>
									Відомості про власників істотної участі (у тому числі осіб,
									які
						...
						<tr>
							...
							<td>
								<strong>
									Відомості про фінансові показники діяльності фінансової
									установи та її
							...
							<td>
								<p>
									З інформацією про основні показники діяльності Товариства на
									підставі
						...
						<tr>
							...
							<td>
								<strong>
									...
									протягом
									якого здійснюється надання відповідних видів фінансових
									послуг, а саме
							...
							<td>
								<p>
									<strong>Робочі дні (крім святкових і неробочих
										днів):</strong>{' '}
						...
						<tr>
							...
							<td>
								<strong>Річна фінансова та консолідована фінансова
									звітність</strong>
							</td>
							<td>
								<strong>
									...
									Товариства разом
									з аудиторським звітом, що підтверджує її достовірність, у
									строки,
									визначені Законом України «Про бухгалтерський облік та
									фінансову
						...
						<tr>
							...
							<td>
								<strong>
									...
									оприлюдненню відповідно до законодавства України, шляхом
									розкриття
							...
							<td>
								<strong>
									Інша інформація про Товариство, що підлягає оприлюдненню
									відповідно до
									законодавства України, шляхом розкриття звітних даних про
									діяльність
									Товариства, що складається та подається відповідно до вимог
									законів з
									питань регулювання ринків фінансових послуг розміщена на
									власному
									сайті Товариства.
								</strong>
							</td>
						...
						<tr>
							...
							<td>
								<strong>
									Відомості про початок процедури ліквідації надавача фін.
									послуг
								</strong>
							</td>
							<td>
								<strong>Рішення про ліквідацію Товариства не
									приймалося.</strong>
							</td>
						</tr>
						<tr>
							...
							<td>
								<strong>
									Фінансова послуга надається Товариством без участі
									посередників.
								</strong>
							</td>
						</tr>
						<tr>
							...
							<td>
								<strong>Інформація про умови та порядок надання фін.
									послуг</strong>
							</td>
							<td>
								<strong>
									На сайті Товариства розміщена копія внутрішніх правил, та
									ціни/тарифи
									надання фінансової послуги.
								</strong>
							</td>
						...
						<tr>
							...
							<td>
								<strong>
									Контактна інформацію органу, який здійснює державне
									регулювання
								</strong>
							</td>
							<td>
								<strong>
									Національний банк України: 01601, м. Київ, вулиця
									Інститутська, 9
									<br/>
									Тел.: 0 800 505 240, email:{' '}
									<a href="mailto:nbu@bank.gov.ua">nbu@bank.gov.ua</a>
									<br/>
									Головне управління Держпродспоживслужби в м. Києві: м. Київ,
									вул.
									Некрасовська, 10/8.; Тел.: +38 (044) 486-54-86,{' '}
									<a
										href="mailto:info@kyiv-dpss.gov.ua">info@kyiv-dpss.gov.ua</a>
								</strong>
							</td>
						</tr>
						<tr>
							...
							<td>
								<strong>
									На сайті Товариства розміщена інформація про вартість,
									ціну/тарифи,
									розмір плати щодо продуктів ТОВ «ФОРТЕКС-ФІНАНС» за видом
									фінансової
									послуги.
								</strong>
							</td>
						...
						<tr>
							...
							<td>
								<strong>
									Інформація про механізми захисту прав споживачів фінансових
									послуг
								</strong>
							</td>
							<td>
								<strong>
									На сайті Товариства розміщена інформація про механізми захисту
									прав
						...
						<tr>
							...
							<td>
								<strong>
									...
									результаті отримання фінансової послуги здійснюється
									відповідно до
						...
						<tr>
							...
							<td>
								...
								<br/>
								<strong>а) наявність у клієнта права на відмову від
									договору</strong>
							</td>
							<td>
								<strong>
									Клієнт має право відмовитися від Договору надання фінансової
									послуги
									протягом 14 календарних днів з дня його укладення шляхом
									подання
						...
						<tr>
							...
							<td>
								Дострокове припинення надання фінансової послуги здійснюється
								внаслідок
								розірвання Договору. Порядок і підстави розірвання Договору
								визначаються Договором. У разі розірвання Договору клієнт та
								Товариство
								зобов’язуються провести взаємні розрахунки:
								<ul>
									<li>
										Товариство за заявою клієнта переказує залишок коштів
										клієнта на
										банківський рахунок.
									</li>
									<li>
										Клієнт повинен погасити усю існуючу заборгованість перед
										Товариством.
									</li>
								</ul>
							</td>
						...
						<tr>
							...
							<td>
								<strong>Договір про надання фінансових послуг:</strong>
								<br/>
								<strong>ґ) Порядок внесення змін та доповнень до
									договору</strong>
							</td>
							<td>
								Зміни та доповнення вносяться до Договору за взаємною згодою
								сторін.
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<br/>
								<strong>
									Неможливість збільшення фіксованої процентної ставки без
									письмової
									згоди споживача фінансової послуги
								</strong>
							</td>
							<td>
								Процентна ставка, встановлена Договором, є фіксованою та не може
								бути
						...
						<tr>
							...
							<td colSpan={2}>
								До фінансових послуг Товариством не застосовуються гарантійні
								фонди або
								компенсаційні схеми. Якщо клієнт не надає необхідні документи,
								Товариство має право відмовити в укладенні Договору. Механізм
								захисту
						...
						<tr>
							...
							<td>
								<strong>
									Розмір винагороди фінансової установи у разі пропозиції
									фінансових
									послуг іншими установами
								</strong>
							</td>
							<td>
								Товариство не надає і не пропонує фінансові послуги, які
								надаються
						...
						<tr>
							...
							<td>
								<strong>
									Правові наслідки та порядок розрахунків при достроковому
									припиненні
									надання фінансової послуги
								</strong>
							</td>
							<td>
								Позичальник може достроково повернути кредит, сплативши відсотки
								за
								фактичний залишок і термін користування кредитом. Штрафи чи
								комісії за
						...
						<tr>
							...
							<td colSpan={2}>
								<p style={{textAlign: 'center'}}>
									<strong>
										Механізми захисту прав споживачів (клієнтів) ТОВ
										«ФОРТЕКС-ФІНАНС»
									</strong>
								</p>
								<p>
									Кожен клієнт має право звернутися до Товариства для розгляду
									звернень.
									Спори вирішуються шляхом переговорів за участю Товариства.
								</p>
								<p>
									Механізми захисту прав споживачів включають позасудовий
									розгляд
									звернень відповідно до Закону України «Про звернення
									громадян».
								...
								<ul>
									...
									<li>
										Електронною поштою:{' '}
										<a
											href="mailto:fortexfinance@ukr.net">fortexfinance@ukr.net</a>;
									</li>
									<li>
								...
								<br/>
								<p>
									Також клієнт може звернутися до Національного банку України
									або
						...
						<tr>
							...
							<td>
								<strong>
									Посилання на структури власності Товариства на сайті
									Національного
									банку України
								</strong>
							</td>
							<td>
								<a
									href="https://bank.gov.ua/ua/supervision/licensing-nonbanking/shareholders-nfp/39859779">
			...
			<article className={s.inner}>
				<h2 className={s.title}>
					Інформація про фінансову послугу, яку надає ТОВ «ФОРТЕКС-ФІНАНС»
					клієнту
				</h2>
				<p>
					Вартість, ціна/тарифи, розмір плати (проценти, винагорода) щодо
					продуктів
					ТОВ «ФОРТЕКС-ФІНАНС» за видом фінансової послуги з надання коштів та
					банківських металів у кредит, що пропонуються юридичним особам та
					фізичним
					особам-підприємцям.
				</p>
				...
				<div className={s.table}>
					<table>
						...
						<tr>
							...
							<td>Фіксована, від 14% до 47% річних на залишок заборгованості
							</td>
						</tr>
						</tbody>
					</table>
				...
				<br/>
				<p>
					Для кредитів, які пропонуються ТОВ «ФОРТЕКС-ФІНАНС» клієнтам розмір
					плати,
					ціни/тарифи, вартість можуть бути встановлені індивідуально за
					результатами
